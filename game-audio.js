const GameAudio = {
    ...
    speakColumnAdd(v1, v2, carryIn, sumVal, writeDigit, newCarry, onComplete) {
        const list = [];

        if (v1 !== null && v2 !== null) {
            list.push('jame_sotoon', String(v1), 'ba', String(v2));
            if (carryIn > 0) {
            ...
            const singleVal = v1 !== null ? v1 : v2;
            if (carryIn > 0) {
                list.push(String(singleVal), 'ba', String(carryIn), 'enteqal_mishe', ...this.numToFiles(sumVal));
            }
        }
